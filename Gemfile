...
gem 'pwb', git: 'https://github.com/ihomeiworld/property_web_builder'

# , branch: 'link-model-support'
# gem 'globalize', git: 'https://github.com/globalize/globalize'
#gem 'paloma', git: 'https://github.com/fredngo/paloma'
gem 'paloma', git: 'https://github.com/ihomeiworld/paloma'
...
gem 'property_web_scraper', git:  'https://github.com/ihomeiworld/property_web_scraper'
